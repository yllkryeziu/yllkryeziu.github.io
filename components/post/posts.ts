...
export const POSTS: PostMeta[] = [
  {
    ...
    dek: "Super Mario 64's long jump multiplies backwards speed without bound, which is how a 1996 sign bug became a 70-star skip. I wired the decompiled game up as an environment and asked PPO to find that bug from a reward that pays only for reaching the top of the stairs. One seed in six finds it, after 6.3M steps. Adding the obvious height bonus takes that to zero in six.",
    date: 'September 2026',
    sortDate: 202610,
    readingMinutes: 18,
